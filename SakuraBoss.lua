...
ProgressBarBackground.Position = UDim2.new(0.5, 0, 0, 75)
...
------------------------------------------------------------------------
-- 2. PANEL DE LOGIN / VERIFICACIÓN (UI AJUSTADA)
------------------------------------------------------------------------
...
LogoFrame.Position = UDim2.new(0.5, 0, 0, 16)
LogoFrame.BackgroundColor3 = Color3.fromRGB(255, 110, 150)
...
TitleLbl.Position = UDim2.new(0.5, 0, 0, 66)
TitleLbl.BackgroundTransparency = 1
TitleLbl.Text = "Sakura Verification"
TitleLbl.TextColor3 = Color3.fromRGB(255, 220, 235)
TitleLbl.Font = Enum.Font.FredokaOne
TitleLbl.TextSize = 16
TitleLbl.Parent = LoginFrame

local StatusText = Instance.new("TextLabel")
StatusText.Size = UDim2.new(1, -30, 0, 18)
StatusText.AnchorPoint = Vector2.new(0.5, 0)
StatusText.Position = UDim2.new(0.5, 0, 0, 90)
StatusText.BackgroundTransparency = 1
StatusText.Text = "Ingresa tu Key para continuar"
StatusText.TextColor3 = Color3.fromRGB(220, 170, 195)
StatusText.Font = Enum.Font.GothamMedium
StatusText.TextSize = 11
StatusText.Parent = LoginFrame

local KeyContainer = Instance.new("Frame")
KeyContainer.Size = UDim2.new(1, -40, 0, 38)
KeyContainer.AnchorPoint = Vector2.new(0.5, 0)
KeyContainer.Position = UDim2.new(0.5, 0, 0, 118)
KeyContainer.BackgroundColor3 = Color3.fromRGB(35, 15, 28)
KeyContainer.BackgroundTransparency = 0.4
KeyContainer.Parent = LoginFrame
...
KeyBox.Text = ""
KeyBox.PlaceholderText = "Key aquí..."
KeyBox.TextColor3 = Color3.fromRGB(255, 230, 240)
KeyBox.PlaceholderColor3 = Color3.fromRGB(160, 110, 135)
...
GetKeyBtn.Size = UDim2.new(0.46, -4, 0, 36)
GetKeyBtn.Position = UDim2.new(0, 20, 0, 166)
GetKeyBtn.BackgroundColor3 = Color3.fromRGB(45, 20, 36)
GetKeyBtn.BackgroundTransparency = 0.3
GetKeyBtn.Text = "🔑 Get Key"
GetKeyBtn.TextColor3 = Color3.fromRGB(255, 160, 190)
...
CheckBtn.Size = UDim2.new(0.46, -4, 0, 36)
CheckBtn.Position = UDim2.new(1, -20 - (147 - 4), 0, 166)
CheckBtn.BackgroundColor3 = Color3.fromRGB(255, 110, 150)
...
FooterLbl.Size = UDim2.new(1, -30, 0, 18)
FooterLbl.AnchorPoint = Vector2.new(0.5, 1)
FooterLbl.Position = UDim2.new(0.5, 0, 1, -10)
FooterLbl.BackgroundTransparency = 1
FooterLbl.Text = "where petals fall, magic follows"
FooterLbl.TextColor3 = Color3.fromRGB(180, 130, 155)
FooterLbl.Font = Enum.Font.GothamItalic
FooterLbl.TextSize = 9
FooterLbl.Parent = LoginFrame
...
MF.Size, MF.Position, MF.BackgroundColor3, MF.Active, MF.Visible, MF.Parent = UDim2.new(0,350,0,240), UDim2.new(0.5,-175,0.5,-120), Color3.fromRGB(22,12,18), true, false, ScreenGui
...
------------------------------------------------------------------------
-- 4. ESP & AIM ENGINE (SIN SISTEMA DE ESTRELLAS)
------------------------------------------------------------------------
...
local function VerifyKey(enteredKey, isAutoLogin)
    ...
    if isValid then
        ...
        DeleteSavedKey()
        if isAutoLogin then
            StatusText.Text = "⚠️ Key expirada"
        else
