...
------------------------------------------------------------------------
-- 1. SPLASH SCREEN (SIN PROCESOS PENDIENTES)
------------------------------------------------------------------------
...
SplashSubText.Size, SplashSubText.Position, SplashSubText.BackgroundTransparency, SplashSubText.Text, SplashSubText.TextColor3, SplashSubText.Font, SplashSubText.TextSize, SplashSubText.Parent = UDim2.new(1,0,0,20), UDim2.new(0,0,0,125), 1, "Cargando recursos...", Color3.fromRGB(200, 150, 175), Enum.Font.GothamMedium, 10, SplashCard

------------------------------------------------------------------------
-- 2. PANEL DE KEY (TRANSPARENTE SAKURA)
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- 5. LÓGICA DE DESBLOQUEO Y VERIFICACIÓN
------------------------------------------------------------------------
local function UnlockScript()
    IsAuthenticated = true
    StartCheatEngine()
    
    TweenService:Create(SplashBlur, TweenInfo.new(0.3), {Size = 0}):Play()
...
------------------------------------------------------------------------
-- 6. FLUJO DIRECTO Y GARANTIZADO (SPLASH -> LOGIN)
------------------------------------------------------------------------
task.spawn(function()
    -- Animación progresiva mediante tiempos fijos
    TweenService:Create(SplashBarFill, TweenInfo.new(0.8, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.new(0.5, 0, 1, 0)}):Play()
    task.wait(0.8)
    
    SplashSubText.Text = "Verificando archivos..."
    TweenService:Create(SplashBarFill, TweenInfo.new(0.6, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.new(1, 0, 1, 0)}):Play()
    task.wait(0.6)
    ...
    -- Carga automática si hay key guardada
