...
------------------------------------------------------------------------
-- 1. SPLASH SCREEN MINIMALISTA (EXTRAÍDO DE TU CÓDIGO)
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- 2. PANEL DE KEY (VERIFICACIÓN DE SEGURIDAD)
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- 4. ESP & AIM ENGINE (SISTEMA AUTENTICADO)
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- 5. LÓGICA DE VERIFICACIÓN & DESBLOQUEO
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- 6. EJECUCIÓN SECUENCIAL (SPLASH SECUENCIA -> LOGIN)
------------------------------------------------------------------------
local sequence = {
...
task.spawn(function()
    ...
    -- Mostrar Panel de Login al terminar la Splash Screen
    LoginFrame.Visible = true
    
    -- Auto-Login si la Key existe localmente
