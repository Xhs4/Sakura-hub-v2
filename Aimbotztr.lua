...
-- Slider FOV: 0 a 100 COM TRAVA ABSOLUTA
...
-- ====================================================================
-- ===== FOV CIRCLE - GUI (Funciona em qualquer executor) =====
-- ====================================================================

-- Cria um ScreenGui separado pro círculo
...
-- Cria o círculo (um frame redondo)
...
-- Cantos arredondados pra fazer o círculo
...
-- ===== FUNÇÃO AUXILIAR: PEGAR A PARTE DO ESP =====
	...
	if EspEnabled then
		for plr, obj in pairs(EspObjects) do
			...
			if espPart and hum and hum.Health > 0 then
				...
				if onScreen then
					-- Box no centro da parte (Head ou Torso)
					local boxSize = 10
					...
					-- Linha do centro da tela até o player
