...
CenterContainer.Name, CenterContainer.Size, CenterContainer.AnchorPoint, CenterContainer.Position, CenterContainer.BackgroundTransparency, CenterContainer.Parent = "CenterContainer", UDim2.new(0,260,0,260), Vector2.new(0.5,0.5), UDim2.new(0.5,0,0.5,0), 1, MainFrame

local FlowerBase = Instance.new("Frame")
FlowerBase.Name, FlowerBase.Size, FlowerBase.AnchorPoint, FlowerBase.Position, FlowerBase.BackgroundColor3, FlowerBase.BackgroundTransparency, FlowerBase.BorderSizePixel, FlowerBase.Rotation, FlowerBase.Parent = "FlowerBase", UDim2.new(0,90,0,90), Vector2.new(0.5,0.5), UDim2.new(0.5,0,0.35,0), Color3.fromRGB(255,140,185), 1, 0, 45, CenterContainer
Instance.new("UICorner", FlowerBase).CornerRadius = UDim.new(0.4,0)

local FlowerStroke = Instance.new("UIStroke")
FlowerStroke.Color, FlowerStroke.Thickness, FlowerStroke.Transparency, FlowerStroke.Parent = Color3.fromRGB(255,205,225), 3, 1, FlowerBase

local InnerGlow = Instance.new("Frame")
InnerGlow.Size, InnerGlow.AnchorPoint, InnerGlow.Position, InnerGlow.BackgroundColor3, InnerGlow.BackgroundTransparency, InnerGlow.BorderSizePixel, InnerGlow.Parent = UDim2.new(0,45,0,45), Vector2.new(0.5,0.5), UDim2.new(0.5,0,0.5,0), Color3.fromRGB(255,255,255), 1, 0, FlowerBase
Instance.new("UICorner", InnerGlow).CornerRadius = UDim.new(1,0)

local StatusLabel = Instance.new("TextLabel")
StatusLabel.Name, StatusLabel.Size, StatusLabel.AnchorPoint, StatusLabel.Position, StatusLabel.BackgroundTransparency, StatusLabel.Text, StatusLabel.TextColor3, StatusLabel.TextSize, StatusLabel.Font, StatusLabel.TextTransparency, StatusLabel.Parent = "StatusLabel", UDim2.new(1,100,0,30), Vector2.new(0.5,0.5), UDim2.new(0.5,0,0.7,0), 1, "", Color3.fromRGB(255,230,242), 18, Enum.Font.GothamBold, 1, CenterContainer

local ProgressBarBackground = Instance.new("Frame")
ProgressBarBackground.Name, ProgressBarBackground.Size, ProgressBarBackground.AnchorPoint, ProgressBarBackground.Position, ProgressBarBackground.BackgroundColor3, ProgressBarBackground.BackgroundTransparency, ProgressBarBackground.BorderSizePixel, ProgressBarBackground.Parent = "ProgressBarBackground", UDim2.new(1,0,0,6), Vector2.new(0.5,0.5), UDim2.new(0.5,0,0.82,0), Color3.fromRGB(60,30,50), 1, 0, CenterContainer
...
TweenService:Create(FlowerBase, TweenInfo.new(0.6), {BackgroundTransparency = 0.2}):Play()
TweenService:Create(FlowerStroke, TweenInfo.new(0.6), {Transparency = 0}):Play()
TweenService:Create(InnerGlow, TweenInfo.new(0.6), {BackgroundTransparency = 0.4}):Play()
TweenService:Create(ProgressBarBackground, TweenInfo.new(0.6), {BackgroundTransparency = 0.5}):Play()

task.spawn(function()
    while FlowerBase and FlowerBase.Parent do
        local pIn = TweenService:Create(FlowerBase, TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {Size = UDim2.new(0,105,0,105), Rotation = 225})
        pIn:Play() pIn.Completed:Wait()
        local pOut = TweenService:Create(FlowerBase, TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {Size = UDim2.new(0,90,0,90), Rotation = 405})
        pOut:Play() pOut.Completed:Wait()
    end
end)
...
task.spawn(function()
    ...
    TweenService:Create(FlowerBase, exitInfo, {BackgroundTransparency = 1}):Play()
    TweenService:Create(FlowerStroke, exitInfo, {Transparency = 1}):Play()
    TweenService:Create(InnerGlow, exitInfo, {BackgroundTransparency = 1}):Play()
