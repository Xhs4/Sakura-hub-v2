...
local Config = {
    ...
    KeyURL = "https://example.com/getkey", -- Reemplazar con tu API / URL de key
    TeamFilter = {}
}
local ESP, IsAimingRightClick = {}, false
local KeyFileName = "Sakura_SavedKey.txt"

-- Multi-Platform HTTP Request
local httpRequest = (syn and syn.request) or (http and http.request) or http_request or (fluxus and fluxus.request) or request

-- Funciones del Sistema de Guardado Local (FileSystem)
...
-- Botón Flotante del Aimbot (Mobile / PC)
...
-- PANTALLA DE AUTHENTICATION / LOGIN
local blur = Instance.new("BlurEffect") blur.Size, blur.Parent = 24, Lighting

local LoginFrame = Instance.new("Frame")
LoginFrame.Name, LoginFrame.Size, LoginFrame.AnchorPoint, LoginFrame.Position, LoginFrame.BackgroundColor3, LoginFrame.Parent = "LoginFrame", UDim2.new(0,340,0,290), Vector2.new(0.5,0.5), UDim2.new(0.5,0,0.5,0), Color3.fromRGB(22,14,24), ScreenGui
Instance.new("UICorner", LoginFrame).CornerRadius = UDim.new(0,16)
local LS = Instance.new("UIStroke", LoginFrame) LS.Color, LS.Thickness = Color3.fromRGB(80,40,65), 1.5
MakeDraggable(LoginFrame)

local LogoFrame = Instance.new("Frame")
LogoFrame.Size, LogoFrame.AnchorPoint, LogoFrame.Position, LogoFrame.BackgroundColor3, LogoFrame.Parent = UDim2.new(0,54,0,54), Vector2.new(0.5,0.5), UDim2.new(0.5,0,0,24), Color3.fromRGB(110,48,78), LoginFrame
Instance.new("UICorner", LogoFrame).CornerRadius = UDim.new(1,0)

local LogoIcon = Instance.new("TextLabel")
LogoIcon.Size, LogoIcon.BackgroundTransparency, LogoIcon.Text, LogoIcon.TextSize, LogoIcon.Parent = UDim2.new(1,0,1,0), 1, "🌸", 26, LogoFrame

local TitleLbl = Instance.new("TextLabel")
TitleLbl.Size, TitleLbl.Position, TitleLbl.BackgroundTransparency, TitleLbl.Text, TitleLbl.TextColor3, TitleLbl.Font, TitleLbl.TextSize, TitleLbl.Parent = UDim2.new(1,0,0,24), UDim2.new(0,0,0,56), 1, "Sakura", Color3.fromRGB(255,255,255), Enum.Font.GothamBold, 18, LoginFrame

local StatusText = Instance.new("TextLabel")
StatusText.Size, StatusText.Position, StatusText.BackgroundTransparency, StatusText.Text, StatusText.TextColor3, StatusText.Font, StatusText.TextSize, StatusText.Parent = UDim2.new(1,0,0,20), UDim2.new(0,0,0,84), 1, "", Color3.fromRGB(130,225,160), Enum.Font.GothamMedium, 12, LoginFrame

local KeyContainer = Instance.new("Frame")
KeyContainer.Size, KeyContainer.Position, KeyContainer.BackgroundColor3, KeyContainer.Parent = UDim2.new(0.9,0,0,42), UDim2.new(0.05,0,0,112), Color3.fromRGB(36,22,38), LoginFrame
Instance.new("UICorner", KeyContainer).CornerRadius = UDim.new(0,8)
local KeyStroke = Instance.new("UIStroke", KeyContainer) KeyStroke.Color, KeyStroke.Thickness = Color3.fromRGB(75,42,65), 1

local LeftAccent = Instance.new("Frame")
LeftAccent.Size, LeftAccent.Position, LeftAccent.BackgroundColor3, LeftAccent.Parent = UDim2.new(0,3,0.7,0), UDim2.new(0,8,0.15,0), Color3.fromRGB(120,200,140), KeyContainer
Instance.new("UICorner", LeftAccent).CornerRadius = UDim.new(1,0)

local KeyBox = Instance.new("TextBox")
KeyBox.Size, KeyBox.Position, KeyBox.BackgroundTransparency, KeyBox.Text, KeyBox.PlaceholderText, KeyBox.TextColor3, KeyBox.PlaceholderColor3, KeyBox.Font, KeyBox.TextSize, KeyBox.ClearTextOnFocus, KeyBox.Parent = UDim2.new(1,-24,1,0), UDim2.new(0,18,0,0), 1, "", "Ingrese su Key aquí...", Color3.fromRGB(240,240,240), Color3.fromRGB(140,120,135), Enum.Font.Code, 11, false, KeyContainer

local GetKeyBtn = Instance.new("TextButton")
GetKeyBtn.Size, GetKeyBtn.Position, GetKeyBtn.BackgroundColor3, GetKeyBtn.Text, GetKeyBtn.TextColor3, GetKeyBtn.Font, GetKeyBtn.TextSize, GetKeyBtn.Parent = UDim2.new(0.42,0,0,38), UDim2.new(0.05,0,0,168), Color3.fromRGB(48,26,42), "🔑 Get Key", Color3.fromRGB(255,160,190), Enum.Font.GothamBold, 11, LoginFrame
Instance.new("UICorner", GetKeyBtn).CornerRadius = UDim.new(0,8)

local CheckBtn = Instance.new("TextButton")
CheckBtn.Size, CheckBtn.Position, CheckBtn.BackgroundColor3, CheckBtn.Text, CheckBtn.TextColor3, CheckBtn.Font, CheckBtn.TextSize, CheckBtn.Parent = UDim2.new(0.46,0,0,38), UDim2.new(0.49,0,0,168), Color3.fromRGB(48,26,42), "🛡️ Check Key", Color3.fromRGB(240,240,240), Enum.Font.GothamBold, 11, LoginFrame
Instance.new("UICorner", CheckBtn).CornerRadius = UDim.new(0,8)

local FooterLbl = Instance.new("TextLabel")
FooterLbl.Size, FooterLbl.Position, FooterLbl.BackgroundTransparency, FooterLbl.Text, FooterLbl.TextColor3, FooterLbl.Font, FooterLbl.TextSize, FooterLbl.Parent = UDim2.new(1,0,0,20), UDim2.new(0,0,1,-24), 1, "where petals fall, magic follows", Color3.fromRGB(100,75,95), Enum.Font.GothamItalic, 10, LoginFrame

-- Verificación de Key e Integración de Auto-Login
local function VerifyKey(enteredKey, isAutoLogin)
    if enteredKey == "" or not enteredKey then return false end
    ...
    if isValid then
        ...
        LeftAccent.BackgroundColor3 = Color3.fromRGB(130,225,160)
        task.wait(0.5)
        ...
        LeftAccent.BackgroundColor3 = Color3.fromRGB(255,100,120)
